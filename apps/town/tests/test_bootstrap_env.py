...
def test_dotenv_path_resolves_to_apps_town():
    ...
    expected_path = Path("/home/hq/projects/ai-agent-virtual-life/apps/town/.env")
    assert expected_path.exists(), f"期望 .env 在 {expected_path}"
    # 验证 bootstrap.py 当前路径
    bootstrap_file = Path("/home/hq/projects/ai-agent-virtual-life/apps/town/src/town/bootstrap.py")
...
def test_env_example_uses_posix_compliant_names():
    ...
    from pathlib import Path
    env_example = Path("/home/hq/projects/ai-agent-virtual-life/apps/town/.env.example")
...
def test_minimax_api_key_is_loaded_from_dotenv():
    ...
    env_path = Path("/home/hq/projects/ai-agent-virtual-life/apps/town/.env")
